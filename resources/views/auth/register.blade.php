...
<head>
    ...
    <title>Autopart | Registrarse</title>
</head>
<body>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-label-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Escriba Nombre" required autocomplete="name" autofocus>
                            <label for="name">Escriba Nombre</label>
                            @error('email')
                        ...
                        <div class="form-label-group">
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password"  placeholder="Escriba Confirmación de la Contraseña">
                            <label for="password-confirm">Escriba Confirmación de la Contraseña</label>
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div style="text-align: center;margin-top: 10px">
                            <p>¿Ya esta registrado? <a href="{{ route('login') }}">Iniciar Sesión</a></p>
                        </div>
